...
\begin{itemize}
  ...
  Wagner-Fisher algorithm~\cite{wagner-fischer}. \C{edit\_seq} uses a
  slight modification of Wagner-Fischer, that also lets it compute the
  edit sequence (an \C{edit list}). The implementation specified in
...
by merging Alice's and Bob's quantity as per \C{Qty.merge} semantics.
