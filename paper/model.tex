...
{\bf Lists}.  \KC{Why don't we call these ropes?} As an abstract data type, lists support three
...
\begin{itemize}
	...
	\item  \C{op\_transform} takes a pair of edit sequences, $s_1$ and $s_2$,
		...
		\C{D} edit must delete the the second element from $v_2$, if it were to
